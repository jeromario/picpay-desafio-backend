CREATE TABLE IF NOT EXISTS WALLETS (
    ...
    "PASSWORD" VARCHAR(10), "TYPE" INT, BALANCE DECIMAL(10,2)
);

CREATE INDEX IF NOT EXISTS cpf_idx ON WALLETS (CPF);

CREATE INDEX IF NOT EXISTS email_idx ON WALLETS (EMAIL);
